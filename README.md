...
Alongside this work, I have contributed to applied finance and public policy research at the Harris School, building reproducible computational tools for [forward-rate curve estimation](https://drive.google.com/file/d/17ADHPGc95_g8DQkionbmAZPg1dn7Dylo/view) and perceived cost-of-capital analysis using large bond datasets. I have also worked on political economy and development policy projects in the Indian context, including data-driven analysis of national budgets, [agricultural finance](https://drive.google.com/file/d/17ADHPGc95_g8DQkionbmAZPg1dn7Dylo/view), and voter behavior, with an emphasis on translating empirical findings into actionable policy insights.

My quantitative training spans econometrics, causal inference, machine learning, and numerical modeling. Before graduate school, I was trained as a mechanical engineer and worked on applied machine learning problems, publishing peer-reviewed research on [fault detection using supervised learning and time-series data](https://drive.google.com/file/d/1S8JqcraSrLkiDR_8nvPf8nUJF6AggI9a/view). That engineering background still shapes how I approach economic research: I care deeply about data construction, model validation, and robustness before interpretation.
